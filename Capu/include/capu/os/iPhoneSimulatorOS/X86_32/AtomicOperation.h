...
#ifndef CAPU_IPHONESIMULATOROS_X86_32_ATOMICOPERATION_H
#define CAPU_IPHONESIMULATOROS_X86_32_ATOMICOPERATION_H
...
namespace capu
{
    namespace os
    {
        namespace arch
        {
            ...
            {
            public:
                using capu::iphoneos::AtomicOperation::AtomicLoad;
                using capu::iphoneos::AtomicOperation::AtomicStore;
...
#endif //CAPU_IPHONESIMULATOROS_X86_32_ATOMICOPERATION_H
