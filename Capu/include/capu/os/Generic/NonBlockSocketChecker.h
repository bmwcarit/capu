...
#ifndef CAPU_GENERIC_NONBLOCKSOCKETCHECKER_H
...
namespace capu
{
    namespace generic
    {
        ...
        inline status_t NonBlockSocketChecker::CheckSocketsForIncomingDataInternal(const vector<capu::os::SocketInfoPair>& socketsToCheck, timeval* timeout)
        {
            ...
            {
                capu::os::SocketInfoPair socketInfo = *current;
                const capu::os::SocketDescription& sockedDescription = socketInfo.first;
...
#endif // CAPU_WINDOWS_X86_64_NONBLOCKSOCKETCHECKER_H
