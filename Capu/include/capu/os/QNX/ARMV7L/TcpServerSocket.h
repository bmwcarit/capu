...
#ifndef CAPU_QNX_ARMV7L_TCPSERVERSOCKET_H
#define CAPU_QNX_ARMV7L_TCPSERVERSOCKET_H


#include <capu/os/QNX/TcpServerSocket.h>
...
#endif // CAPU_QNX_ARMV7L_TCPSERVERSOCKET_H
