...
#ifndef CAPU_INTEGRITY_TCPSERVERSOCKET_H
#define CAPU_INTEGRITY_TCPSERVERSOCKET_H
...
namespace capu
{
    namespace os
    {
        ...
        public:
            ...
            using capu::posix::TcpServerSocket::getSocketDescription;
        };
    }
}
#endif // CAPU_INTEGRITY_TCPSERVERSOCKET_H
