...
#ifndef CAPU_INTEGRITY_X86_64_FILE_H
#define CAPU_INTEGRITY_X86_64_FILE_H

#include <capu/os/Integrity/File.h>
    ...
    namespace os
    {
        namespace arch
        {
            ...
            public:
                ...
                using capu::os::File::getCurrentPosition;
...
#endif // CAPU_INTEGRITY_X86_64_FILE_H
