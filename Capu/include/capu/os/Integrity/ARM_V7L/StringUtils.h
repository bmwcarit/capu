...
#ifndef CAPU_INTEGRITY_ARM_V7L_STRINGUTILS_H
#define CAPU_INTEGRITY_ARM_V7L_STRINGUTILS_H

#include <capu/os/Integrity/StringUtils.h>
...
#endif // CAPU_INTEGRITY_ARM_V7L_STRINGUTILS_H
