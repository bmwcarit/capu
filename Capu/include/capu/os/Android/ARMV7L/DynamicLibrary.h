...
#ifndef CAPU_ANDROID_ARM_V7L_DYNAMICLIBRARY_H
#define CAPU_ANDROID_ARM_V7L_DYNAMICLIBRARY_H

#include <capu/os/Linux/DynamicLibrary.h>
...
#endif // CAPU_ANDROID_ARM_V7L_DYNAMICLIBRARY_H
