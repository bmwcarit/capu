...
{
    EXPECT_EQ(CAPU_TYPE_PRIMITIVE, capu::Type<uint64_t>::Identifier);
    EXPECT_EQ(CAPU_TYPE_PRIMITIVE, capu::Type<uint32_t>::Identifier);
    EXPECT_EQ(CAPU_TYPE_PRIMITIVE, capu::Type<int32_t>::Identifier);
    EXPECT_EQ(CAPU_TYPE_PRIMITIVE, capu::Type<uint16_t>::Identifier);
    EXPECT_EQ(CAPU_TYPE_PRIMITIVE, capu::Type<int16_t>::Identifier);
    EXPECT_EQ(CAPU_TYPE_PRIMITIVE, capu::Type<uint8_t>::Identifier);
    EXPECT_EQ(CAPU_TYPE_PRIMITIVE, capu::Type<int8_t>::Identifier);
    ...
    EXPECT_EQ(CAPU_TYPE_REFERENCE, capu::Type<uint32_t&>::Identifier);
