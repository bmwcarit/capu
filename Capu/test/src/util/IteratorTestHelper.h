...
namespace capu
{
    ...
    class IteratorTestCompilation<ITERATABLE, input_iterator_tag>
    {
    protected:
    ...
    template<typename ITERATABLE>
    class IteratorTestCompilation<ITERATABLE, forward_iterator_tag> : public IteratorTestCompilation<ITERATABLE, input_iterator_tag>
    {
    protected:
        typedef typename IteratorTestCompilation<ITERATABLE, input_iterator_tag>::Iterator Iterator;
    ...
    public:
        void runTests(ITERATABLE& iteratable)
        {
            IteratorTestCompilation<ITERATABLE, input_iterator_tag>::runTests(iteratable);
    ...
    template<typename ITERATABLE>
    class IteratorTestCompilation<ITERATABLE, bidirectional_iterator_tag> : public IteratorTestCompilation<ITERATABLE, forward_iterator_tag>
    {
    protected:
        typedef typename IteratorTestCompilation<ITERATABLE, forward_iterator_tag>::Iterator Iterator;
    ...
    public:
        ...
        void runTests(ITERATABLE& iteratable)
        {
            IteratorTestCompilation<ITERATABLE, forward_iterator_tag>::runTests(iteratable);
    ...
    template<typename ITERATABLE>
    class IteratorTestCompilation<ITERATABLE, random_access_iterator_tag> : public IteratorTestCompilation<ITERATABLE,  bidirectional_iterator_tag>
    {
    private:

        typedef typename IteratorTestCompilation<ITERATABLE, bidirectional_iterator_tag>::Iterator Iterator;
    ...
    public:
        ...
        void runTests(ITERATABLE& iteratable)
        {
            IteratorTestCompilation<ITERATABLE, bidirectional_iterator_tag>::runTests(iteratable);
    ...
    template<>
    struct HasIteratorTag<input_iterator_tag, input_iterator_tag>
    {
        static const bool result = true;
    };

    template<>
    struct HasIteratorTag<forward_iterator_tag, forward_iterator_tag>
    {
        static const bool result = true;
    };

    template<>
    struct HasIteratorTag<bidirectional_iterator_tag, bidirectional_iterator_tag>
    {
        static const bool result = true;
    };

    template<>
    struct HasIteratorTag<random_access_iterator_tag, random_access_iterator_tag>
    {
        static const bool result = true;
    };
