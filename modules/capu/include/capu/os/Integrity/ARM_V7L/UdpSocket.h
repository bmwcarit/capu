...
#ifndef CAPU_INTEGRITY_ARM_V7L_UDP_SOCKET_H
#define CAPU_INTEGRITY_ARM_V7L_UDP_SOCKET_H

#include <capu/os/Integrity/UdpSocket.h>
...
#endif /* CAPU_INTEGRITY_ARM_V7L_UDP_SOCKET_H */
