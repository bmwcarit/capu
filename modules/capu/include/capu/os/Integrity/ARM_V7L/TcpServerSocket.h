...
#ifndef CAPU_INTEGRITY_ARM_V7L_TCPSERVERSOCKET_H
#define CAPU_INTEGRITY_ARM_V7L_TCPSERVERSOCKET_H


#include <capu/os/Integrity/TcpServerSocket.h>
...
#endif // CAPU_INTEGRITY_ARM_V7L_TCPSERVERSOCKET_H
