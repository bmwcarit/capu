...
#ifndef CAPU_INTEGRITY_ARM_V7L_SEMAPHORE_H
#define CAPU_INTEGRITY_ARM_V7L_SEMAPHORE_H

#include <capu/os/Integrity/Semaphore.h>
...
#endif // CAPU_INTEGRITY_ARM_V7L_SEMAPHORE_H
