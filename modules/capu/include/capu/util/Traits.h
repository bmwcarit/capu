...
#ifndef CAPU_TRAITS_H
#define CAPU_TRAITS_H
...
#define CAPU_TYPE_NONE      0
    ...
    template<> struct is_CAPU_PRIMITIVE<float_t >
    {
        enum { Value = CAPU_TYPE_PRIMITIVE   };
    };
    template<> struct is_CAPU_PRIMITIVE<double_t>
    {
        enum { Value = CAPU_TYPE_PRIMITIVE   };
    };
    ...
    struct Type
    {
        ...
        {
            Identifier =
                capu::is_CAPU_PRIMITIVE<T>::Value
                | capu::is_CAPU_POINTER<T>::Value
                | capu::is_CAPU_REFERENCE<T>::Value
                | capu::is_CAPU_ENUM<T>::Value
                | capu::is_CAPU_CLASS<T>::Value
        };
    };
