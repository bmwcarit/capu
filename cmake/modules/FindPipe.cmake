...
ELSEIF("${TARGET_OS}" STREQUAL "Integrity")
    ...
    FIND_PATH(${PACKAGE_NAME}_INCLUDE_DIRS unistd.h /INTEGRITY-include )
    FIND_LIBRARY(${PACKAGE_NAME}_LIBRARIES NAMES ivfs PATHS /intarmv7a_vfp_common )
