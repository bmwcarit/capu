	...
	IF(CONFIG_CREATE_BUILD_REPORT)
		IF(NOT "${DOXYGEN_EXECUTABLE}" STREQUAL "DOXYGEN_EXECUTABLE-NOTFOUND")
			...
			IF(EXISTS ${DOXYGEN_EXECUTABLE})
				...
				MESSAGE(STATUS "Build report successfully created!")
			ELSE()
				MESSAGE(STATUS "WARNING: The doxygen executable ${DOXYGEN_EXECUTABLE} doesn't exist.")
				MESSAGE(STATUS "WARNING: The build report was not created.")
			ENDIF()
		ENDIF()	
	ENDIF()	
