...
FUNCTION(INTERNAL_ADD_EXTERNAL_LIBRARY ial_name)
	...
	SET(${ial_name}_LIBRARY_DIRS "" CACHE INTERNAL "")
	FOREACH(ial_library_dir ${IAL_LIBRARY_DIRS})
		SET(${ial_name}_LIBRARY_DIRS ${${ial_name}_LIBRARY_DIRS} "${ial_library_dir}" CACHE INTERNAL "")
	ENDFOREACH()
...
FUNCTION(INTERNAL_ADD_MODULE_INTERNAL ami_module_name ami_type)
	...
	SET(${CURRENT_MODULE_NAME}_OUTPUT_NAME            "" CACHE INTERNAL "")
...
FUNCTION(INTERNAL_ADD_DEPENDENCY ad_name)
	...
	IF("${ad_name}_FOUND")
        ...
        LIST(LENGTH ${CURRENT_MODULE_NAME}_DEPENDENCIES listLength)
        IF(listLength GREATER 1)
            LIST(REVERSE ${CURRENT_MODULE_NAME}_DEPENDENCIES)
...
FUNCTION(INTERNAL_BUILD_UNIT_TESTS)
	IF(${CONFIG_BUILD_GLOBAL_TEST_EXECUTABLE} AND NOT "${GLOBAL_TEST_SOURCE}" STREQUAL "")
		...
		LINK_DIRECTORIES(${GoogleTest_LIBRARY_DIRS} ${GoogleMock_LIBRARY_DIRS} ${GLOBAL_TEST_LINKER_DIRECTORIES})
		...
		MESSAGE(VERBOSE INTERNAL_BUILD_UNIT_TESTS "Global unit test executable enabled, building Test")
        ...
        MESSAGE(VERBOSE INTERNAL_BUILD_UNIT_TESTS "linking GLOBAL_TEST_LIBS=${GLOBAL_TEST_LIBS}")
...
MACRO(INTERNAL_INSTALL_EXTERNAL_TARGETS)
	...
	IF(NOT "${GLOBAL_EXTERNAL_LIBRARIES_INSTALL_DIR}" STREQUAL "${CMAKE_INSTALL_PREFIX}")
		INSTALL(DIRECTORY "${GLOBAL_EXTERNAL_LIBRARIES_INSTALL_DIR}/" DESTINATION "${CMAKE_INSTALL_PREFIX}" OPTIONAL PATTERN ".svn" EXCLUDE )
	ENDIF()
ENDMACRO(INTERNAL_INSTALL_EXTERNAL_TARGETS)


FUNCTION(INTERNAL_SET_OUTPUT_NAME outputname)
	SET(${CURRENT_MODULE_NAME}_OUTPUT_NAME ${outputname} CACHE INTERNAL "")
ENDFUNCTION()
