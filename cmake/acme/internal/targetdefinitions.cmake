...
#FUNCTION(INTERNAL_ADD_RELEASE_COMPILER_FLAGS_TO_TARGET acf_target)
#	INTERNAL_LIST_TO_STRING("${ARGN}" ARGN)
#	SET_TARGET_PROPERTIES(${acf_target} PROPERTIES COMPILE_FLAGS "${ARGN}" )
#
#	SET(CMAKE_C_FLAGS_RELEASE ${CMAKE_C_FLAGS_RELEASE} ${ARGN})
#	SET(CMAKE_CXX_FLAGS_RELEASE ${CMAKE_CXX_FLAGS_RELEASE} ${ARGN})
#	INTERNAL_LIST_TO_STRING("${CMAKE_C_FLAGS_RELEASE}" CMAKE_C_FLAGS_RELEASE)
#	INTERNAL_LIST_TO_STRING("${CMAKE_CXX_FLAGS_RELEASE}" CMAKE_CXX_FLAGS_RELEASE)
#ENDFUNCTION(INTERNAL_ADD_RELEASE_COMPILER_FLAGS_TO_TARGET)